...
void checaVitoria() {
  ...
  if((celulas[0] == '1') && (celulas[1] == '2') && (celulas[2] == '3')) {
    //horizontal 1
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na horizontal 1");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //horizontal 2
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na horizontal 2");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //horizontal 3
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na horizontal 3");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //vertical 1
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na vertical 1");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //vertical 2
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na vertical 2");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //vertical 3
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na vertical 3");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //diagonal 1
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na diagonal 1");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
    ...
    //diagonal 2
    vitoria = 1;
    Serial.println("Vitoria do jogador 2 na diagonal 2");
    Wire.write(key);
    Wire.write('f');
    pontuacao_jogador2++;
    mostrarPontuacao();
